var ContactForm = React.createClass({
  ...
  handleSubmit: function(e) {
    e.preventDefault();
    url = '/api/v1/messages';
    if (this.props.messageId) url += ('/' + this.props.messageId);
  ...
  handleChange: function(e) {
    if (e.target.id == 'message_name') this.setState({ name: e.target.value });
    if (e.target.id == 'message_email') this.setState({ email: e.target.value });
